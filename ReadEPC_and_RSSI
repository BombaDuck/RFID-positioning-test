...
void setup()
{
  ...
  nano.setReadPower(500); //10.00 dBm. Higher values may cause USB port to brown out
  //Max Read TX Power is 27.00 dBm and may cause temperature-limit throttling
  nano.setWritePower(500); //10.00 dBm. Higher values may cause USB port to brown out
...
void loop()
{
  ...
  { 
    ...
    //byte myEPC = nano.getTagEPCBytes();
